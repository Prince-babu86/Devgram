  ...
  return (
    <div className="h-screen w-full bg-blue-500 relative ">
      <div
        ...
        className="flex absolute top-4 left-3 items-center justify-center text-white"
      >
      ...
      <div className="sign-up absolute h-[63vh] w-full bg-slate-100  z-[100] bottom-0 rounded-t-[35px]">
        <h1 className="text-3xl text-blue-500 font-semibold text-center mt-4">
          Get Started
        </h1>
        <form onSubmit={handleOnSubmit} action="" className="px-4">
          <div className="frm flex items-start justify-start flex-col gap-[5px] mb-5">
            ...
            <input
              ...
              onChange={Onchange}
              name="name"
              className="w-full p-2 outline-none border-[1.5px] border-gray-600 rounded-[10px] placeholder:text-[14px]"
              type="text"
          ...
          <button
            type="submit"
            className="w-full bg-blue-500 text-white py-2 rounded-[10px]"
          >
            Sign up
          </button>
        </form>
